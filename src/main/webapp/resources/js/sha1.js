...
var SHA = function(){
	...
	this.str_sha1 = function str_sha1(s) {
		return binb2str(core_sha1(str2binb(s), s.length * chrsz));
	};
	this.hex_hmac_sha1 = function hex_hmac_sha1(key, data) {
		return binb2hex(core_hmac_sha1(key, data));
	};
	this.b64_hmac_sha1 = function b64_hmac_sha1(key, data) {
		return binb2b64(core_hmac_sha1(key, data));
	};
	this.str_hmac_sha1 = function str_hmac_sha1(key, data) {
